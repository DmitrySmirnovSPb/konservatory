...
class Call_Customer(getContent):
    ...
    def __init__(self, link, nameDB, globalLink, Sheet):
        ...
        self.replacement = {
            '\n':' ','. ':'.', 'ао«дока':'ао «дока', 'cк дока':'ск'+self.gap+'дока', '«':'', '»':'','ск ':'','-центр':'', '-сварго':'','-инжиниринг':'', 'художественно-реставрационная группа ':'','нв билдинг':'нв'+self.gap+'билдинг','ук арт-глас':'арт-глас','"':'','новое время':'новое'+self.gap+'время','политех строй':'политехстрой', 'лепной двор':'лепной'+self.gap+'двор','ван строй':'ван'+self.gap+'строй','метеор лифт':'метеор'+self.gap+'лифт', 'ип хомченко':'ип'+self.gap+'хомченко'
        }
